...
export async function registerRoutes(
  ...
  app.post("/api/seed", async (req, res) => {
    try {
      ...
      // Sample listings with varied prices for deal rating diversity
      const sampleListings = [
        {
          ...
          price: 22900, description: "One owner, dealer maintained. Clean title. Includes Toyota Safety Sense package with adaptive cruise control, lane departure alert, and pre-collision system. Bluetooth, backup camera, 8-inch touchscreen.",
        ...
        },
        {
          ...
          price: 38900, description: "Premium package, panoramic sunroof, heated seats, navigation, Harman Kardon sound system. Factory warranty remaining. Like new condition with low miles.",
        ...
        },
        {
          ...
          price: 42500, description: "Nearly new with full autopilot capability. 330-mile range, 15-inch touchscreen, glass roof, premium audio system. Still under manufacturer warranty. No accidents.",
        ...
        },
        {
          ...
          price: 24900, description: "Limited trim with leather seats, heated front and second row seats, heated steering wheel, navigation, 8.4-inch Uconnect system, advanced safety group. Great for family use.",
        ...
        },
        {
          ...
          price: 46900, description: "Certified pre-owned with extended warranty. Premium package, Burmester sound system, 12.3-inch dual screens, wireless charging, ambient lighting, 360-degree camera.",
        ...
        },
        {
          ...
          price: 18900, description: "SEL package with leather seats, panoramic sunroof, blind spot monitoring, lane keep assist, 8-inch touchscreen with Apple CarPlay. Excellent gas mileage for an AWD SUV.",
        ...
        },
        {
          ...
          price: 29500, description: "Third row seating, SYNC 3 with 8-inch touchscreen, Ford Co-Pilot360, blind spot monitoring, lane keeping system. Great towing capacity. Perfect for large families.",
          condition: "good", city: "Lakewood", state: "NJ", zipCode: "08701",
          images: JSON.stringify([]),
          numOwners: 1, accidentHistory: false, titleStatus: "clean", sellerType: "dealer",
        },
        {
          ...
          price: 29900, description: "Luxury package with Mark Levinson premium audio, navigation, head-up display, panoramic roof, heated and ventilated seats. Lexus reliability with luxury comfort.",
          condition: "good", city: "Monsey", state: "NY", zipCode: "10952",
          images: JSON.stringify([]),
          numOwners: 2, accidentHistory: false, titleStatus: "clean", sellerType: "private",
        },
        {
          ...
          price: 37500, description: "S Line sport package, virtual cockpit plus, Bang & Olufsen 3D sound, heated/ventilated seats, adaptive cruise, top view camera. Like-new condition.",
          condition: "excellent", city: "Brooklyn", state: "NY", zipCode: "11230",
          images: JSON.stringify([]),
          numOwners: 1, accidentHistory: false, titleStatus: "clean", sellerType: "dealer",
        },
        {
          ...
          price: 33900, description: "8-passenger seating, SofTex leather seats, sunroof, 12.3-inch touchscreen, JBL audio, Toyota Safety Sense 2.5, wireless charging. One of the best family SUVs.",
